class Floor_5 extends Phaser.Scene{
    ...
    preload(){
        this.load.image('BG5', './assets/floor5BG.png');
    ...
    create(){
        this.createKeys();
        this. background = this.add.image(game.config.width/2, game.config.height/2, 'BG5');
